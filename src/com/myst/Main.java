...
import com.myst.world.entities.Bullet;
...
new Vector2f(0.5f,0.5f), botBullets);
    
    bot.localID = IDCounter;
    bot.owner = clientID;
    IDCounter++;

    bot.transform.pos.add(1, -1, 1);

    bot.initialiseAI(world);
    bot.setPath(new Vector3f(48,-61,1));
